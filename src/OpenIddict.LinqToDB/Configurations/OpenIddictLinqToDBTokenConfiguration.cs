...
namespace OpenIddict.LinqToDB
{
    ...
    public class OpenIddictLinqToDBTokenConfiguration<TToken, TApplication, TAuthorization, TKey> : IEntityTypeConfiguration<TToken>
        ...
        where TKey : IEquatable<TKey>
    {
        public void Configure(EntityTypeBuilder<TToken> builder)
        {
            ...
            builder.HasIndex(nameof(OpenIddictLinqToDBToken.ReferenceId))
                   .IsUnique();

            builder.HasIndex(
                nameof(OpenIddictLinqToDBToken.Application) + nameof(OpenIddictLinqToDBApplication.Id),
                nameof(OpenIddictLinqToDBToken.Status),
                nameof(OpenIddictLinqToDBToken.Subject),
                nameof(OpenIddictLinqToDBToken.Type));
